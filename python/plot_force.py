...
plt.plot(tSPHsmooth, xSPHFsmooth-fxS, color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH')
#plt.plot(tSPHsmooth, xSPHTsmooth, color='C3', linestyle=':', marker='', linewidth=SPH_LINE, label='SPH-T')
plt.xlim([tmin, tmax])
plt.ylim([xmin, xmax])
plt.xlabel('Time (s)')
...
plt.plot(tSPHsmooth, zSPHFsmooth-fzS, color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH')
#plt.plot(tSPHsmooth, zSPHTsmooth, color='C3', linestyle=':', marker='', linewidth=SPH_LINE, label='SPH-T')
plt.xlim([tmin, tmax])
plt.ylim([zmin, zmax])
plt.xlabel('Time (s)')
...
#plt.plot(tENxsmooth, xEXPsmooth, color='C4', linestyle='--', marker='', label='Experimental Jakobsen et al., 2016')
#plt.plot(tENxsmooth, xNUMsmooth, color='C2', linestyle=':', marker='', label='RANS-VOF Ransley et al, 2017')
#plt.plot(tSPHsmooth, mSPHsmooth, color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH')
#plt.xlim([tmin, tmax])
#plt.ylim([xmin, xmax])
#plt.xlabel('Time (s)')
