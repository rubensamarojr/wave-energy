...
#plt.plot(tSPH, SPH_0 - SPH_0[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.plot(tSPHsmooth, SPH_0smooth - SPH_0smooth[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.xlim([tmin, tmax])
plt.ylim([zmin, zmax])
plt.xlabel('Time (s)')
...
#plt.plot(tSPH, SPH_1 - SPH_1[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.plot(tSPHsmooth, SPH_1smooth - SPH_1smooth[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.xlim([tmin, tmax])
plt.ylim([zmin, zmax])
plt.xlabel('Time (s)')
...
#plt.plot(tSPH, SPH_2 - SPH_2[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.plot(tSPHsmooth, SPH_2smooth - SPH_2smooth[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.xlim([tmin, tmax])
plt.ylim([zmin, zmax])
plt.xlabel('Time (s)')
...
#plt.plot(tSPH, SPH_3 - SPH_3[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.plot(tSPHsmooth, SPH_3smooth - SPH_3smooth[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.xlim([tmin, tmax])
plt.ylim([zmin, zmax])
plt.xlabel('Time (s)')
...
#plt.plot(tSPH, SPH_4 - SPH_4[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.plot(tSPHsmooth, SPH_4smooth - SPH_4smooth[0], color='C1', linestyle='-', marker='', linewidth=SPH_LINE, label='SPH-DVI')
plt.xlim([tmin, tmax])
plt.ylim([zmin, zmax])
plt.xlabel('Time (s)')
